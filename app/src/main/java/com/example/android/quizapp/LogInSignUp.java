...
public class LogInSignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (auth.getCurrentUser() != null) {
            ...
            startActivity(new Intent(LogInSignUp.this, Begin.class));
            finish();
        }
        signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseExpenses.child("Profile").child(id).setValue(profile);
                ...
                progressBar.setVisibility(View.VISIBLE);
                auth.createUserWithEmailAndPassword(mail,assword).addOnCompleteListener(LogInSignUp.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        Toast.makeText(LogInSignUp.this, "createUserWithEmail:onComplete:" + task.isSuccessful(), Toast.LENGTH_SHORT).show();
        ...
        logIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                progressBar.setVisibility(View.VISIBLE);
                auth.signInWithEmailAndPassword(mail,assword).addOnCompleteListener(LogInSignUp.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        Toast.makeText(LogInSignUp.this, "createUserWithEmail:onComplete:" + task.isSuccessful(), Toast.LENGTH_SHORT).show();
                        progressBar.setVisibility(View.GONE);
